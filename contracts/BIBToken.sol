...
contract BIBToken is ERC20, Ownable {
    ...
    // bsc mainnet: bep20usdt = 0x55d398326f99059fF775485246999027B3197955;
    ...
    constructor() ERC20("BIBToken", "BIB") {
        ...
        dividendTracker = new TokenDividendTracker("BIB_Dividend_Tracker", "BIB_Dividend_Tracker", usdt);
    ...
    function swapAndSendTreasury() private {
        swapTokensForUsdt(treasuryBalance, treasury);
        treasuryBalance = 0;
    }
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) external onlyOwner {
        require(pair != uniswapV2Pair, "bib: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
